...
# 选择 启动了自动图腾功能的玩家+背包有图腾，副手没图腾的。
execute as @a[scores={zxmc.totem=1},nbt={Inventory:[{id:"minecraft:totem_of_undying"}]}] at @s[nbt=!{Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying"}]}] run function totem:step2_auto_totem
